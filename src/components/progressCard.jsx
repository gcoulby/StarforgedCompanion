      ...
      <React.Fragment>
        ...
        <div className="col-12 col-lg-6">
          <div className="card vow-card mb-4">
            <div className="card-header bg-dark text-light orbitron">
              <div className="row ">
                  ...
                  <React.Fragment>
                    <div className="col text-right">
                      <select
                        ...
                        className="form-control orbitron bg-dark text-light"
            ...
            <div className="card-body">
              <div className="row mt-3">
                <div className="col">
                  ...
                  <span className="orbitron mt-2">Additional Details:</span>
                  <textarea
                    disabled={this.props.progression.complete}
                    type="text"
                    className="form-control"
              ...
              {this.props.showThreats ? (
                <React.Fragment>
                  <div className="row mt-4">
                    <div className="col">
                      <span className="orbitron mt-2">Threat:</span>
                      <div className="input-group mb-2">
                        <div className="input-group-prepend">
                          <button
                            disabled={this.props.progression.complete}
