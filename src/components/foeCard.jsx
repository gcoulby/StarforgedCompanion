      ...
      <React.Fragment>
        <div className={`card foe-card ${this.props.idx != undefined ? `foe-card-${this.props.idx}` : ""}`}>
          ...
          <div className="card-body">
            ...
            />
            {/* <span className="orbitron mt-3">DESCRIPTION</span> */}
            ...
            {/* <span className="orbitron mt-3">QUEST</span> */}
            {/* {this.props.foe.Quest !== undefined ? <p>{this.props.foe.Quest}</p> : React.Fragment} */}
            {/* <span className="orbitron mt-3">FEATURES</span>
                    ...
                    {this.props.static || this.props.foe.complete ? (
                      ...
                      <React.Fragment>
                        <select
                          ...
                          className="form-control orbitron"
