  ...
  render() {
    return (
      <React.Fragment>
        ...
        <span className="orbitron">Ironsworn</span> game. This companion could not exist without Shawn's work and since
        ...
        There were several content developers from the <span className="orbitron">Ironsworn</span> community that
        deserve an honourable mention here. During the creation of this companion the following people provided direct
        or indirect support to this app.
        ...
        <span className="orbitron">Ironsworn</span> tabletop RPG. This app was not designed to replace the official
        rules nor was it designed to superseed the work done by Shawn Tomkin.
        <br />
        <br />
