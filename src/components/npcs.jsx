              ...
              <div key={`${npc.id}_${npc.id}`} className="col-lg-6 col-sm-12">
                <div className="card my-3">
                  <div className="card-body">
                    ...
                    <div className="row">
                      <div className="col-md-6 col-sm-12">
                        <span className="orbitron">Race: </span>
                        <span>{npc.race}</span>
                      </div>
                      <div className="col-md-6 col-sm-12">
                        <span className="orbitron">Role: </span>
                        <span>{npc.role}</span>
                      </div>
                    </div>
                    <div className="row">
                      <div className="col-md-6 col-sm-12">
                        <span className="orbitron">Goal: </span>
                        <span>{npc.goal}</span>
                      </div>
                      <div className="col-md-6 col-sm-12">
                        <span className="orbitron">Descriptor: </span>
                        <span>{npc.descriptor}</span>
                      </div>
                    </div>
                    <div className="row">
                      <div className="col">
                        <span className="orbitron">Disposition: </span>
                        <span>{npc.disposition}</span>
                      </div>
                    </div>
                    <div className="row">
                      <div className="col">
                        <span className="orbitron">Conversation: </span>
                        <span>{npc.conversation}</span>
                      </div>
                    </div>
                    <div className="row">
                      <div className="col">
                        <span className="orbitron">Knowledge: </span>
